...
//    public DateTime FechaTrabajo;
    ...
    public RecepcionFajilla(long sucursalId, long tipoFajilla, String folio, int cantidad){
        this.SucursalId = sucursalId;
        this.TipoFajilla = tipoFajilla;
        this.Folio = folio;
        this.Cantidad = cantidad;
    ...
    public RecepcionFajilla(long sucursalId, long tipoFajilla, int cantidad){
        this.SucursalId = sucursalId;
        this.TipoFajilla = tipoFajilla;
        this.Cantidad = cantidad;
    }
