...
public class ListAdapterFormasPago extends ArrayAdapter<String> {
    ...
    public ListAdapterFormasPago(Activity context, List<String> maintitle, List<String> subtitle, List<String> total1) {
