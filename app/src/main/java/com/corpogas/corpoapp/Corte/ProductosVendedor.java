...
import com.corpogas.corpoapp.Corte.Adapters.ListAdapterProductosVendedor;
...
public class ProductosVendedor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_productos_vendedor);
    ...
    private void init() {
        listProductos = (ListView) findViewById(R.id.listProductosVendedor);
        btnAutorizacion = (Button) findViewById(R.id.btnConfirmarInventarioVendedor);
        btnVentaProductos = (Button) findViewById(R.id.btnProductosFaltantesVendedor);
    ...
    private void setVariables() {
        ...
        modales = new Modales(ProductosVendedor.this);
    }
    ...
    private void onClicks(){
        btnAutorizacion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View viewLectura = modales.MostrarDialogoInsertaDato(ProductosVendedor.this, mensaje, titulo);
        ...
        btnVentaProductos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProductosVendedor.this, VentasProductos.class); //claveFinVenta
    ...
    private void MostrarProductosCierre(String Response, Integer opcion){
        ...
        try {
            ...
            for (int i = 0; i < cierredetalles.length(); i++) { //cierredetalles.length() //3
                ...
                Long cantidadV = pA.getLong("Cantidad");
                Long total = pA.getLong("Total");
                ...
                //               } else {
                //                   maintitle.add("-");
                maintitle.add(String.valueOf(total));
                subtitle.add(DescLarga + " (" + idArticulo + ")");
                calculo.add(String.valueOf(cantidadV));
...
//                dbCorte.InsertarInventarioProductos(100000, VentaProductos, 0, "codigobarras", "DescLarga", 0, 0, 0, 0, 0 );
        ...
        ListAdapterProductosVendedor adapterV = new ListAdapterProductosVendedor(ProductosVendedor.this, calculo, subtitle, maintitle);
        listProductos.setTextFilterEnabled(true);
        listProductos.setAdapter(adapterV);
    }
    ...
    public void usuarioCorrecto(){
        ...
        if (correcto == true) {
            if (respuestaApiAccesoUsuario.getObjetoRespuesta().getClave().equals(nipAutorizacion) && respuestaApiAccesoUsuario.getObjetoRespuesta().getNumeroInternoRol() == 1) {
                ...
                intent.putExtra("banderaConfirmaInventarioVendedor", banderaConfirmaInventario);
//                intent.putExtra("accesoUsuario", respuestaApiAccesoUsuario);
                startActivity(intent);
                finish();

            } else {
                edtNipAutorizacion.setError("No eres vendedor");
            }
