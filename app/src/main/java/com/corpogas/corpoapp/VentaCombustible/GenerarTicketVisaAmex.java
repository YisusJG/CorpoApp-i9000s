...
public class GenerarTicketVisaAmex extends AppCompatActivity {
    SQLiteBD data;
    String EstacionId, sucursalId, ipEstacion;
    String Usuarioid , CargaPosicion, UsuarioClave, FormaPagoId, nombreCompletoVenta,  numeroempleado, lugarProviene;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_generar_ticket_visa_amex);
    ...
    private void init(){
        ...
        CargaPosicion = data.getposcioncarga();
        UsuarioClave = data.getClave();
        FormaPagoId = data.getformapagoid();
        nombreCompletoVenta = data.getNombreCompleto();
        MontoEnCanasta= data.getMontoFPD(Integer.parseInt(FormaPagoId));
    ...
    private void Moduloimprime(){
        if (!Conexion.compruebaConexion(this)) {
            ...
            try {
                ...
                FormasPagoObjecto.put("TramaBancariaDetalle", data.getresponseFPD(Integer.parseInt(FormaPagoId)));
            ...
            JsonObjectRequest request_json = new JsonObjectRequest(Request.Method.POST, url, datos, new Response.Listener<JSONObject>() {
                    ...
                    try {
                        ...
                        if (detalle.equals("null")) {
                            ...
                            try {
                                ...
                                Modales modales = new Modales(GenerarTicketVisaAmex.this);
                                View view1 = modales.MostrarDialogoError(GenerarTicketVisaAmex.this, mensaje);
                            ...
                            String titulo = "AVISO";
                            Modales modales = new Modales(GenerarTicketVisaAmex.this);
                            View view1 = modales.MostrarDialogoCorrecto(GenerarTicketVisaAmex.this, "Ticket enviado a impresora central");
                            view1.findViewById(R.id.buttonAction).setOnClickListener(new View.OnClickListener() { //buttonYes
                                @Override
                                public void onClick(View view) {
                                    Intent intent = new Intent(getApplicationContext(), Menu_Principal.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(GenerarTicketVisaAmex.this, "error", Toast.LENGTH_SHORT).show();
